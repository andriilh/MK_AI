 ...
 * @author radhial22
 */
public class entitas_aplikanperpesenter {
     private String nama;
    private int hp;
    ...
    public entitas_aplikanperpesenter() {
    }

    public entitas_aplikanperpesenter(String nama, int hp, Date tgl_datang, Date tgl_daftar, Date tgl_ujian, String tahun_ajaran, String jurusan, Date tgl_reg, String presenter) {
        this.nama = nama;
        this.hp = hp;
