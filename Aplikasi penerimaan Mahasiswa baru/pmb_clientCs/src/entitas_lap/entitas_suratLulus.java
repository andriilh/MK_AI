 ...
 * @author radhial22
 */
public class entitas_suratLulus {
     private String nama;
    ...
    public entitas_suratLulus() {
    }

    public entitas_suratLulus(String nama, String no_ujian, String jurusan, String test1, String waktu1, String test2, String waktu2, String test3, String waktu3, String grade) {
        this.nama = nama;
