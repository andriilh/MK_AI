...
//        
//        String currntDir = prop.getProperty("user.dir");
//        
//        File dir = new File(currntDir);
//        String nmLap = "newReport.jasper";
//        String lokasi = "report";
//        
//        File filap;
//        String fulpath = null;
//        
...
//            
//            for(int t = 0;t <isiDir.length;t++){
//                filap = new File(currntDir+File.separatorChar+isiDir[t]+File.separatorChar+lokasi+File.separatorChar+nmLap);
//                if(filap.isFile()){
//                    fulpath=filap.toString();
//                }
//            }
//        }
//       
...
//            String url ="jdbc:mysql://localhost:3306/db_pmb";
//            String user = "root";
//            String pass = "root";
//
...
//
//            try {
//                //JasperReport jlaporan = JasperCompileManager.compileReport(fulpath);
//
//                        JasperPrint jcetak = JasperFillManager.fillReport(fulpath,koneksi);
//                    JasperViewer.viewReport(jprin, false);
//
//            } catch (Exception e) {
//               Logger.getLogger(form_soal.class.getName()).log(Level.SEVERE, null, e);
//            }
//        } catch (Exception e) {
//            Logger.getLogger(form_soal.class.getName()).log(Level.SEVERE, null, e);
//        }
