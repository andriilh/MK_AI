...
public class editNilai extends javax.swing.JFrame {
    ...
    public editNilai(String a,String b) {
        initComponents();
        jnis.setText(a);
        jnama.setText(b);
        jm.setVisible(false);
    ...
    private void simpanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_simpanMouseClicked
        hitung();
        int id = 0;
        String sql = "UPDATE daftarnilai SET nis=?,nama=?,mtk=?,ipa=?,bind=?,jumlah=?,rata=? WHERE nis='"+jnis.getText()+"'";
